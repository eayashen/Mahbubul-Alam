...
const Home = () => {
  ...
  const fetchDesignation = async () => {
    ...
    try {
      const response = await fetch(
        "https://port.abirmunna.me/api/v1/designation"
      );
      const jsonData = await response.json();
  ...
  const fetchProfileImage = async () => {
    try {
      const response = await fetch(
        "https://port.abirmunna.me/api/v1/image/uploads/pro_pic.png"
      );
  ...
  const handleSaveImage = () => {
    //api call
    const apiUrl = "https://port.abirmunna.me/api/v1/image/uploads";
  ...
  const handleBioDelete = (id) => {
    const deleteDesignation = async () => {
      try {
        const response = await fetch(
          `https://port.abirmunna.me/api/v1/designation?id=${id}`,
          {
            method: "DELETE",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleSaveAward = () => {
    if (award && award.id !== undefined) {
      const updateAward = async () => {
        try {
          const response = await fetch(
            "https://port.abirmunna.me/api/v1/awards",
            {
              method: "PUT",
              headers: {
                "Content-Type": "application/json",
  ...
  const handleDeleteAward = (id) => {
    const deleteAward = async () => {
      try {
        const response = await fetch(
          `https://port.abirmunna.me/api/v1/awards?id=${id}`,
          {
            method: "DELETE",
            headers: {
              "Content-Type": "application/json",
